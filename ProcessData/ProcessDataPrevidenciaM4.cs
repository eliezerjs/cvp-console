...
{
    public class ProcessDataPrevidenciaM4
    {
        private readonly IPrevidenciaM4Service _previdenciaM4Service;

        public ProcessDataPrevidenciaM4(IPrevidenciaM4Service previdenciaM4Service)
        {
            _previdenciaM4Service = previdenciaM4Service ?? throw new ArgumentNullException(nameof(previdenciaM4Service));
        }

        public async Task ProcessFilesAsync(string inputPath, string outputPath, string processedFilesPath, PrevidenciaM4Type tipo)
        {
